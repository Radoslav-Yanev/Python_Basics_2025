...
while True:
    ...
    if first_player_card > second_player_card:
        ...
        print("Number wars!")
        first_player_card_card = int(input())
        second_player_card_card = int(input())

        if first_player_card_card > second_player_card_card:
            print(f"{first_player_name} is winner with {first_player_points} points")

        elif first_player_card_card < second_player_card_card:
